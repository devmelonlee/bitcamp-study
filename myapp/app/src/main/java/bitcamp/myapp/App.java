...
public class App {
  ...
  public static void main(String[] args) {
    ...
    MemberHandler memberHandler = new MemberHandler(prompt); // -> 의존객체 주
    BoardHandler boardHandler = new BoardHandler(prompt); // 힙에 만들어진다.
    BoardHandler readingHandler = new BoardHandler(prompt); // 레퍼런스핸들러, 랭스 변수 만들어짐 배열 따로따로 유
