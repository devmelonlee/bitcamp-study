  ...
  <tr>
      ...
      <td style='width:300px;'>
        ...
        <c:if test="${not empty member.photo}">
          <a href='https://kr.object.ncloudstorage.com/bitcamp-nc7-bucket-08/member/${member
          .photo}'>

      <img src='http://ppgzynbiloni19010741.cdn.ntruss.com/member/${member.photo}?type=f&w=60&h=80&faceopt=true&ttype=jpg'>
                </a>
              </c:if>
        ...
        <tr>
            ...
            <td><select name='gender'>
                ...
                <option value='W' ${String.valueOf(member.getGender()) == 'W' ? "selected" : ""}>여자</option></select>
            </td>
        </tr>
  </table>
<div>
