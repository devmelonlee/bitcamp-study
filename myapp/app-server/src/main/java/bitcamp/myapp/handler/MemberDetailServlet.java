    ...
    if (member == null) {
      ...
      out.printf("<tr><th style='width:120px;'>사진</th>" + " <td style='width:300px;'>"
          + (member.getPhoto() == null ? "<img style='height:80px' src='/images/avatar.png'>"
              : "<a href='https://kr.object.ncloudstorage.com/bitcamp-nc7-bucket-08/member/%s'>"
                  + "<img src='http://ppgzynbiloni19010741.cdn.ntruss.com/member/%1$s?type=f&w=60&h=80&faceopt=true&ttype=jpg'>"
                  + "</a>")
